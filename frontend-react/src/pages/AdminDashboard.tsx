...
const AdminDashboard = () => {
  ...
  return (
    <Container className="py-5">
      <h2 className="text-dark fw-bold mb-4">Command Center // Registry</h2>
      ...
      <Button variant="link" href="/dashboard" className="text-decoration-none fw-bold text-muted p-0">&lt; Back to Dashboard</Button>
    </Container>
  );
};
